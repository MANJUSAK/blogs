package com.manjusaka.blogs.config.redis;
 ...
 * ===>redis配置类
 *
 * @author manjusaka[manjusakachn@gmail.com] Created on 2018-01-29 14:06
 * @version V1.1.0
 */
@Configuration
public class RedisConfig extends CachingConfigurerSupport {
    ...
    public RedisSentinelConfiguration redisSentinelConfiguration() {
        this.LOG.info("blogs start inited redisSentinel");
    ...
    public JedisConnectionFactory jedisConnectionFactory() {
        this.LOG.info("blogs start inited redisConnectionFactory");
    ...
    public RedisTemplate<Object, Object> redisTemplate() {
        this.LOG.info("blogs start inited redisTemplate");
