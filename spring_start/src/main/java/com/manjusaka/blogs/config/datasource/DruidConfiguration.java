package com.manjusaka.blogs.config.datasource;
...
public class DruidConfiguration {
    ...
    public ServletRegistrationBean druidStatViewServelt() {
        ...
        //登录查看信息的账号密码
        servletRegistrationBean.addInitParameter("loginUsername", "manjusaka");
        servletRegistrationBean.addInitParameter("loginPassword", "2015my");
        //备用地址
        servletRegistrationBean.addUrlMappings("/monitor/blogs/*");
        //是否重置数据.
    ...
    public FilterRegistrationBean druidStatFilter() {
        ...
        filterRegistrationBean.addInitParameter("exclusions", "*.js,*.gif,*.jpg,*.jpeg,*.png,*.css,*.ico,/data/monitor/*,/monitor/blogs/*");
